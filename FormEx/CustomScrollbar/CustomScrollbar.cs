...
namespace System.Windows.Forms 
{
    ...
    public class CustomScrollbar : UserControl 
    {
        ...
        public CustomScrollbar() {
            ...
            moChannelColor = Color.FromArgb(218, 236, 246);
        ...
        protected override void OnPaint(PaintEventArgs e) {
            ...
            //draw channel
            e.Graphics.FillRectangle(oBrush, new Rectangle(this.Padding.Left, UpArrowImage.Height, this.Width - this.Padding.Left - this.Padding.Right, (this.Height - DownArrowImage.Height)));
            ...
            //draw top
            e.Graphics.DrawImage(ThumbTopImage, new Rectangle(this.Padding.Left, nTop, this.Width - this.Padding.Left - this.Padding.Right, ThumbTopImage.Height));

            nTop += ThumbTopImage.Height;
            //draw top span
            Rectangle rect = new Rectangle(1, nTop, this.Width - this.Padding.Left - this.Padding.Right, nSpanHeight);


            e.Graphics.DrawImage(ThumbTopSpanImage, this.Padding.Left * 1.0f, (float)nTop, (float)this.Width - this.Padding.Left - this.Padding.Right, (float)fSpanHeight * 2);

            nTop += nSpanHeight;
            //draw middle
            e.Graphics.DrawImage(ThumbMiddleImage, new Rectangle(this.Padding.Left, nTop, this.Width - this.Padding.Left - this.Padding.Right, ThumbMiddleImage.Height));


            nTop += ThumbMiddleImage.Height;
            //draw top span
            rect = new Rectangle(this.Padding.Left, nTop, this.Width - this.Padding.Left - this.Padding.Right, nSpanHeight * 2);
            e.Graphics.DrawImage(ThumbBottomSpanImage, rect);

            nTop += nSpanHeight;
            //draw bottom
            e.Graphics.DrawImage(ThumbBottomImage, new Rectangle(this.Padding.Left, nTop, this.Width - this.Padding.Left - this.Padding.Right, nSpanHeight));
