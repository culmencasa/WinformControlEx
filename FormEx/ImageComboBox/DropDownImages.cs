	...
	public sealed class DropDownImages: System.Drawing.Design.UITypeEditor
	{
		...
		public override void PaintValue(PaintValueEventArgs e)
		{
			if(e.Value .ToString ().CompareTo ("(none)")==0 )
			{
                ...
                e.Graphics.DrawString(dispayStr, imagesContainer.Font, new SolidBrush(imagesContainer.ForeColor), new Rectangle(e.Bounds.Width + 10, 0, (int)TextRenderer.MeasureText(dispayStr, imagesContainer.Font).Width + 10, e.Bounds.Height)); 
			}
