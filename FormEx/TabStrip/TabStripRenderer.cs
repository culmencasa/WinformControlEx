...
namespace System.Windows.Forms
{
    internal class TabStripRenderer : ToolStripRenderer
    {
        ...
        private bool _useVS = Application.RenderWithVisualStyles;

        private Color _inactivedTabBackColor = Color.FromArgb(128, 255, 255, 255);
        ...
        protected override void OnRenderButtonBackground(ToolStripItemRenderEventArgs e)
        {
            ...
            else
            {
                ...
                using (GraphicsPath gp = new GraphicsPath())
                {
                    ...
                    { 
                        using (SolidBrush br = new SolidBrush(_inactivedTabBackColor))
                        {
                            g.FillPath(br, gp);
                        }
                    }
